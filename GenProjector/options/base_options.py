...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default=util.base_dir + '/checkpoints', help='models are saved here')
        ...
        parser.add_argument('--dataroot', type=str,
                            default='/home/wangao/PycharmProjects/Illumination_Estimation/EMLight/3DScenes/')
