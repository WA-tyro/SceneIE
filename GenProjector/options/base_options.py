...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--aspect_ratio', type=float, default=2.0, help='The ratio width/height. The final height of the load image will be crop_size/aspect_ratio')
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='/home/wangao/PycharmProjects/Illumination_Estimation/EMLight/3DScenes/')
